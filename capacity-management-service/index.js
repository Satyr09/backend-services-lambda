...
const SERVICE_PROVIDER_TABLE  = awsConfig.tableName;


exports.handler = async (event, context) => {
    switch(event.httpMethod) {
        case "POST" :
            return await postService.handler(event, DynamoDBClient, SERVICE_PROVIDER_TABLE);
        case "PUT" :
            return await putService.handler(event, DynamoDBClient, SERVICE_PROVIDER_TABLE);
        case "GET" :
            return await getService.handler(event, DynamoDBClient, SERVICE_PROVIDER_TABLE);
        // case "DELETE" :
